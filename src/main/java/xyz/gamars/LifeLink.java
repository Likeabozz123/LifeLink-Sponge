...
import xyz.gamars.listeners.DeathEventListener;
...
public class LifeLink {
    ...
    @Inject
    LifeLink(final PluginContainer container, final Logger logger) {
    ...
    public void onConstructPlugin(final ConstructPluginEvent event) {
        ...
        this.logger.info("Constructing spongeplugin");
        Sponge.eventManager().registerListeners(container, new DeathEventListener());
    }
...
/*        final Parameter.Value<String> nameParam = Parameter.string().key("name").build();
        event.register(this.container, Command.builder()
                ...
                .permission("spongeplugin.command.greet")
                .executor(ctx -> {
